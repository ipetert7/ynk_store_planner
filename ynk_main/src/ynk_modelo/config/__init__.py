...
SSO_SECRET = os.getenv("SSO_SECRET", "ynk-dev-sso-secret-change-in-production")
SSO_TOKEN_TTL = int(os.getenv("SSO_TOKEN_TTL", "900"))
SSO_REFRESH_TTL = int(os.getenv("SSO_REFRESH_TTL", "28800"))
SSO_SYNC_SECRET = os.getenv("SSO_SYNC_SECRET", SSO_SECRET)
