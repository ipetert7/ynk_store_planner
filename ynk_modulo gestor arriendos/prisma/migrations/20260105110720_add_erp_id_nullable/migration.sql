...
CREATE TABLE "new_Store" (
    ...
    "shoppingCenterOperator" TEXT NOT NULL DEFAULT '',
    ...
    "decemberFactor" REAL NOT NULL DEFAULT 1,
    ...
    "autoRenewal" INTEGER NOT NULL DEFAULT 0,
